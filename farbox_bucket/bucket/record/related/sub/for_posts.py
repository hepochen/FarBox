...
from farbox_bucket.utils import to_int, smart_unicode
...
def update_post_tags_words_info(bucket, record_data):
    ...
    tags_info = posts_info.setdefault('tags', {})  # {'paths':{path:tag} ,  'tags': {'tag':[path1, path2]} }
    ...
    if is_deleted or post_status in ['draft', 'private']:
        ...
        for tag in old_tags:
            ...
            if lower_path in tags_info_tags_for_tag_paths:
                ...
                if not tags_info_tags_for_tag_paths: # 空的 tag
